...
# from price_parser.models import Product, Category, ParsedProduct
...
#         product = lemana_pro_parser(product_name)  # должна возвращать или создавать продукт в БД
#
#         if not product:
...
# class SubCategoriesByCategoryView(View):
#     def get(self, request):
#         category_id = request.GET.get('category_id')
#         if not category_id:
